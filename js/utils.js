...
export const files = {
    ...
    vivian:{
        ...
        pages:[
            ...
            `His left hand was firm upon his sword,<br>` +
            ...
            `No <b>blood</b> superior to another.<br><br>`+
 ...
 beast:{
    ...
    beast2:{
        ...
        pages:[
            ...
            'For the sake of clarity, I will refer to it as <b>“The Beast.”</b><br><br>' +
            ...
            `I have identified three distinct layers within the Beast. For ease of communication, I'll borrow psychological terminology.<br><br>` +

            '<b>1. THE ULTRA EGO</b><br>' +
            'These are the <b>Worlds of Rule</b>.<br>' +
            'Places governed by consistency: gravity, causality, time, logic.<br><br>' +

            '<b>Allarssyn</b> is an Ultra Ego world.<br>' +
            'So was my <b>world</b>...<br><br>' +


            '<b>Ultra Ego worlds</b> exist only as long as they are <b>remembered</b> by the Beast.',



            '<b>2. THE EGO (The In-Between)</b><br>' +
            `The Ego, is the center.<br> It's where all things originate from.<br>`+
            'It is a place of, symbols, and irrationality.<br><br>' +

            'This is where myths breathe.<br>' +
            'Where dragons make sense.<br>' +
            'Where impossible geography feels natural.<br><br>' +

            'The Ego functions as a mediator, or a hub between all kind of worlds.<br>' +
            'It is accessed primarily through <b>dreams</b>.<br><br>' +

            'When a person dreams, their consciousness briefly disconnects from the Ultra Ego and through their <b>World shard</b>, into the Ego planes.<br><br>' +
            '<b>*This connection is not optional.*</b><br><br>' +
            '<b>A world that cannot dream is a world that cannot persist.</b>',

            '<b>THE WORLD SHARD</b><br><br>' +
            'Every world must have a <b>World Shard</b> of some form. <br>'+
            'The world shard functions as a gate to, <b>The In-between</b>.<br><br>'+
            'Our dreams act as the string that attaches our world to The Beast, to stop our world from drifting to <b>The Void.</b><br>'+
            'These strings pass through a gate <b><i>The World Shard</i></b> and to the center of all things <b>The Black Pyramid</b><br><br>' +


            '<b>THE BLACK PYRAMID</b><br><br>' +

            'My current theory of what The Black Pyramid Is:<br> a central construct within The in-between.<br>' +
            'I believe to have functioned as a <b>Unified Ego</b>.<br>' +
            'A time where <b>ALL</b> things were one.<br><br>' +

            `This would explain why it's shattered, and why every <b>World Shard</b> is somehow connected to The In-between and The Black Pyramid.<br><br>`,
            ...
            'As it leaves us be.<br><br><br>'+

            '<b>FINAL NOTE</b><br>' +

            'Once a world loses the ability to dream,<br>' +
            '<i>Unable to remind <b>The Ego</b> of their existence.</i><br>' +
            'The world simply dissolve to <b>The void</b>,<br><br>' +
            '<b>*There is no known method of retrieval.*</b><br><br>' +
...
falco:{
    ...
    pages:[
        ...
        <b>FALCO:</b> "Why do you love her this much? Huh? She left you!"<br><br>

        <b>FALCO:</b> "I’m your blood. I’m your son... I'm always on your side... but it’s always her. It’s always been her."<br><br>
        ...
        <b>QUINN:</b> "I- I'm Sorry, Falco."<br><br>

        [EMP GRENADE DETONATION]<br><br>

        <b>[AUDIO ENDS IN STATIC]</b>`
    ]
},
...
quinnLogs:{
    ...
    pages:[
        ...
        <b>VIVI:</b> "He's that strong?! He doesn't really look the part."<br><br>
        ...
        <b>QUINN:</b>"VIVI..."<br><br>

        <b>VIVI:</b>"YES! Quinny Que?"<br><br>
...
projectv:{
    ...
    pages:[
        ...
        'Such features are still in development and will be added to ensure a long-term independence from external protection.<br><br>'
    ]
},
...
quinn:{
    ...
    pages:[
        ...
        I only know that it will reach you.<br><br>
        ...
        <b>That dream is you and others like you, not having to do what we've done and for I... still do.</b><br><br>

        Where you would not have to steal for food.<br>
        Where you would not have to kill for money<br>
        Where you would not have to run from killers<br>
        <b>Where you would not have to die.</b><br><br>` +
        ...
        I never said it. I never claimed it. I had no right.<br><br>
        ...
        Waiting for you.<br>
        Not as some emperor.<br>

        <b>Just some old scared dying man<br><br>
        A man who wants one last chance to speak to his daughter.</b><br><br>

        <b>Please, Quinn.</b><br>

        Come see me. I don't think I have long.<br><br>
        <b>I am scared. Quinn.</b><br><br>
